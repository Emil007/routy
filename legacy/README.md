# Routy v2 — Discord-Routenbot (Legacy)

> **Archiviert.** Dies ist der alte Discord-Bot-Prototyp. Das aktive Projekt ist die
> Next.js-Web-Plattform im Repository-Root. Dieser Ordner bleibt nur als Referenz für
> die bewährte Routing-Logik (Knoten/Segment-Graph, Umkreis-Merge, DFS-Routensuche,
> Fairness-Scoring) erhalten, die in der neuen Plattform nach TypeScript portiert wurde.
