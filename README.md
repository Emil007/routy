...
**Server** (this repo) · **0.37s** · [`Emil007/routy`](https://github.com/Emil007/routy)  
**Android app** · **0.37a** · [`Emil007/routy-android`](https://github.com/Emil007/routy-android)  
*(Aligned release batch: same number, `s` / `a` suffix by repo — tags `v0.37s` / `v0.37a`.)*
...
|-----------|-------------|----------|-------|
| Server | `v0.37s` | **0.37s** | `package.json` |
| Android | `v0.37a` | **0.37a** | `app/build.gradle.kts` |
