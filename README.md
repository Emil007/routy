...
**Server** (this repo) · **0.38s** · [`Emil007/routy`](https://github.com/Emil007/routy)  
**Android app** · **0.38a** · [`Emil007/routy-android`](https://github.com/Emil007/routy-android)  
*(Aligned release batch: same number, `s` / `a` suffix by repo — tags `v0.38s` / `v0.38a`.)*
...
|-----------|-------------|----------|-------|
| Server | `v0.38s` | **0.38s** | `package.json` |
| Android | `v0.38a` | **0.38a** | `app/build.gradle.kts` |
